...
exports.cssLoaders = function (options) {
  ...
  function generateLoaders (loader, loaderOptions) {
    ...
    // 翻译：如果明确指定了需要提取静态文件，则使用ExtractTextPlugin.extract({})来包裹我们的各种css处理器
    if (options.extract) {
  ...
  return {
    ...
    styl: generateLoaders('stylus')// styl-loader
  }
}

// Generate loaders for standalone style files (outside of .vue)
// 翻译:使用这个函数，为那些独立的style文件创建加载器配置。
